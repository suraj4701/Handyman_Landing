...
test("AdminPanel Customer App", async ({ page }) => {
    await page.goto(home_url);
    await page.locator("//li[@id='menu-item-7174']").hover()
    await page.locator("//li[@id='menu-item-4973']").click()
    const visualAnalyticsLinkLocator = page.locator("//a[normalize-space()='customer app']");
    await visualAnalyticsLinkLocator.scrollIntoViewIfNeeded();
    const expectedLink = "https://handyman.iqonic.design/features/client-app/";
