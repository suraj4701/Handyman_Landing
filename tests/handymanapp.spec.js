...
test("Handyman App Provider App Playstore 2", async ({ page }) => {
    ...
    await page.locator("//li[@id='menu-item-7174']").hover()
    await page.locator("//header/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/nav[1]/ul[1]/li[2]/ul[1]/li[1]/a[1]").click()
    const adminpanelLocator = page.locator("//div[@class='elementor-element elementor-element-0c6ea48 elementor-widget__width-auto ob-has-background-overlay elementor-widget elementor-widget-button']//a[@class='elementor-button elementor-button-link elementor-size-md']");
    await adminpanelLocator.scrollIntoViewIfNeeded();
    await HandymanAppPlaystore(page, adminpanelLocator);
})
...
test("Handyman App Provider App AppStore", async ({ page }) => {
    ...
    await page.locator("//li[@id='menu-item-7174']").hover()
    await page.locator("//header/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/nav[1]/ul[1]/li[2]/ul[1]/li[1]/a[1]").click()
    const adminpanelLocator = page.locator("//div[@class='elementor-element elementor-element-625fdfb elementor-widget__width-auto ob-has-background-overlay elementor-widget elementor-widget-button']//a[@class='elementor-button elementor-button-link elementor-size-md']");
    await adminpanelLocator.scrollIntoViewIfNeeded();
